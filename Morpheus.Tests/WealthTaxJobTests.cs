...
public class WealthTaxJobTests
{
    [Fact]
    public async Task Execute_WhenCanceledBeforeCollection_PropagatesCancellation()
    {
        ...
        EconomyService economyService = new(db, new LogsService(new LogQueue()));
        WealthTaxJob job = new(economyService);
