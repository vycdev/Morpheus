...
- Requires guild context: Yes
- Parameters:
  - `channel` — SocketTextChannel? — Optional
...
- Parameters:
  - `pixelScale` — int — Optional
  - `maxOffset` — int — Optional
  - `smoothPasses` — int — Optional
...
- Parameters:
  ...
  - `user2` — SocketGuildUser? — Optional
